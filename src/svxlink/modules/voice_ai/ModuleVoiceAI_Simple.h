#ifndef MODULE_VOICE_AI_SIMPLE_INCLUDED
#define MODULE_VOICE_AI_SIMPLE_INCLUDED
...
private:
    ...
    void sendDtmfCommand(const std::string& command);
...
#endif // MODULE_VOICE_AI_SIMPLE_INCLUDED