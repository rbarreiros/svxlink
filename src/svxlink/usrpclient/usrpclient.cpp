/**
@file    usrpclient.cpp
@brief   Standalone USRP ↔ SvxReflector client – main entry point
...
int main(int argc, const char* argv[])
{
  ...
  if (version_flag)
  {
    cout << "usrpclient v" << SVXLINK_APP_VERSION << " (" << PROJECT_VERSION << ")\n";
    return 0;
  }
  ...
  the_app.exec();
  cout << "UsrpClient shutting down.\n";

  pidfd = static_cast<int>(getpid());  // silence unused variable
  (void)pidfd;
